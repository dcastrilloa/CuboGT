...
urlpatterns = [
	...
	path('torneo/<int:torneo_id>/fase/<int:fase_id>/grupo/generar_eliminatoria', grupo_views.grupo_generar_eliminatoria, name='grupo_generar_eliminatoria'),
	...
	path('torneo/<int:torneo_id>/fase/<int:fase_id>/grupo/borrar_todo', grupo_views.grupo_borrar_todo, name='grupo_borrar_todo'),
